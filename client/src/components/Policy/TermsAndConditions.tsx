...
export function TermsAndConditions () {
  ...
  <TermsAndConditionsContainer>
    ...
    <p>
      ...
      intellectual property rights related to it, still belong to GabojaGo.
    </p>
    <p>
      GabojaGo is committed to ensuring that the app is as useful and efficient
    ...
    <p>
      The Muscle Formula app stores and processes personal data that you have
      ...
      features and it could mean that the Muscle Formula app won’t work properly
      or at all.
    </p>
    <div>
      <p>
      ...
      <ul>
        ...
        <li>
          <a
            href="https://fabric.io/terms/fabric"
            target="_blank"
            rel="noopener noreferrer"
            >Fabric</a
          >
        ...
        <li>
          <a
            href="https://usefathom.com/terms/"
            target="_blank"
            rel="noopener noreferrer"
            >Fathom Analytics</a
          >
    ...
    <p>
      You should be aware that there are certain things that GabojaGo will not
      ...
      provided by your mobile network provider, but GabojaGo cannot take
    ...
    <p>
      Along the same lines, GabojaGo cannot always take responsibility for the
      ...
      Service, GabojaGo cannot accept responsibility.
    </p>
    <p>
      With respect to GabojaGo’s responsibility for your use of the app, when
      ...
      available to you. GabojaGo accepts no liability for any loss, direct or
    ...
    <p>
      ...
      keep using the app. GabojaGo does not promise that it will always update
    ...
    <p>These terms and conditions are effective as of 2022-04-13</p>
    <p><strong>Contact Us</strong></p>
    <p>
      If you have any questions or suggestions about our Terms and Conditions,
      do not hesitate to contact us at muscleformula365@gmail.com.
    </p>
    <p>
