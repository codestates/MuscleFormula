...
export function PrivacyPolicy () {
  ...
  <PrivacyPolicyContainer>
    ...
    <p>
      ...
      is provided by GabojaGo at no cost and is intended for use as is.
    </p>
    <p>
    ...
    <p>
      ...
      Terms and Conditions, which are accessible at Muscle Formula unless
    ...
    <p>
      ...
      not limited to Personally identifiable information (PII) uses data to
      confirm an individual's identity.. The information that we request will be
    ...
    <p>This policy is effective as of 2022-04-13</p>
    <p><strong>Contact Us</strong></p>
    <p>
      If you have any questions or suggestions about our Privacy Policy, do not
      hesitate to contact us at muscleformula365@gmail.com.
    </p>
    <p>
